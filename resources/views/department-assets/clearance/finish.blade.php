...
<div class="hk-pg-wrapper">
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        <div class="hk-pg-header align-items-top">
            <div>
                <h2 class="hk-pg-title font-weight-600 mb-10">Complete Clearance - {{ $clearance->clear_code }}</h2>
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="alert alert-info d-flex justify-content-between align-items-center flex-wrap">
                                <div class="mb-2 mb-md-0">
                                    ...
                                    physically signed by the Returning Employee, IT Manager, and Department Manager.
                                    Then scan or photograph the signed paper and upload it below.
                                </div>
                                <a href="{{ route('clearance.pdf', $clearance->id) }}" target="_blank" class="btn btn-info">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-8 offset-md-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('department-assets.clearance.complete', $clearance->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group">
                                            <label for="clearing_signature">Signed Document <span class="text-danger">*</span></label>
                                            <input type="file" name="clearing_signature" id="clearing_signature" class="form-control @error('clearing_signature') is-invalid @enderror" accept="image/*,application/pdf" required>
                                            @error('clearing_signature')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Upload the signed clearance document (JPG, PNG, SVG, or PDF - Max 2MB)</small>
                                        </div>
                                        ...
                                        <div class="text-right mt-3">
                                            <a href="{{ route('department-assets.show', $department->id) }}" class="btn btn-secondary">Cancel</a>
...
<script>
    document.getElementById('clearing_signature').addEventListener('change', function(e) {
