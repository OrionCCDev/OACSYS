...
<div class="hk-pg-wrapper">
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        <div class="hk-pg-header align-items-top">
            <div>
                <h2 class="hk-pg-title font-weight-600 mb-10">Receive Assets to {{ $department->name }}</h2>
                <p>Select devices and SIM cards to receive to this department</p>
            </div>
            <div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <form action="{{ route('department-assets.receive.store', $department->id) }}" method="POST">
                        @csrf
