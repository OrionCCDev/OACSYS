                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="alert alert-info d-flex justify-content-between align-items-center flex-wrap">
                                <div class="mb-2 mb-md-0">
                                    ...
                                    physically signed by the Returning Employee, IT Manager, and Project Manager.
                    ...
                    <div class="row mt-2">
                        <div class="col-md-8 offset-md-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('project-assets.clearance.complete', $clearance->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="text-right mt-3">
                                            <a href="{{ route('project-assets.show', $project->id) }}" class="btn btn-secondary">Cancel</a>
