                                        ...
                                        <table class="table table-hover mb-0 mt-2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-gradient-danger btn-wth-icon icon-wthot-bg btn-rounded icon-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('receive.show' , ['receive'=> $receive->id]) }}"
                                                            ...
                                                            <span
                                                                class="btn-text">Up-Signature</span><span
                                                                class="icon-label"><i
                                                            ...
                                                            <span
                                                                class="btn-text">Clearance</span><span
                                                                class="icon-label"><i
                                                                    class="fa fa-angle-right"></i>
                                                            </span>
                                                            </button>
            ...
            <div class="card col-12">
                ...
                <div class="table-wrap w-100">
                    <div class="table-responsive  w-100">
                        <table class="table table-hover mb-0 mt-2  w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" wire:click="removeFromPersonDevices({{ $selectedDevice->id }})" class="btn btn-danger btn-sm">
                        ...
                        <div class="row mt-30">
                            <div class="col-auto">
                                <button type="button" wire:click="makeReceiving" {{ empty($this->selectedDevices) || empty($this->selectedPerson) ? 'disabled' : '' }} class="btn btn-gradient-space mb-2">Make Receiving</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card col-12">
                <div class="form-group row">
                    ...
                    <div class="input-group col-12">
                        ...
                        <input type="text" value="" wire:model.live='searchOfDevice' class="form-control" id="basic-url" aria-describedby="basic-addon3">
                    </div>
                </div>
                <div class="table-wrap w-100">
                    <div class="table-responsive  w-100">
                        <table class="table table-hover mb-0 mt-2  w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" {{ empty($this->selectedPerson) ? 'disabled' : '' }}  wire:click="addDeviceToSelection({{ $device->id }})" class="btn btn-gradient-sunset btn-wth-icon btn-rounded icon-right">
                        ...
                        <table class="table table-hover mb-0 mt-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" {{ empty($this->selectedPerson) ? 'disabled' : '' }}  wire:click="addSimToSelection({{ $sim->id }})" class="btn btn-gradient-sunset btn-wth-icon btn-rounded icon-right">
