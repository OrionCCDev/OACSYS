                        ...
                        <div class="container">
                            ...
                            <div class="hk-row">
                                            ...
                                            <div class="card-header card-header-action">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="text-capitalize font-weight-500 text-dark">consultant Info</div>
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="card-body">
                                            <div class="card">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($consultant->devices as $device)
                                                        <tr>
                                    ...
                                    @if ($consultant->sim_card->count() == 0)
                                    <div class="card card-profile-feed mt-4">
                                        <div class="card-header card-header-action">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                        ...
                                        <div class="card-body">
                                            <div class="card">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($consultant->sim_card as $simCard)
                                                        <tr>
