                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <a href="{{ route('receive.create' ,['makeReceiveDeviceId' => $device->id , 'deviceCode' => $device->device_code]) }}"
                                                                        ...
                                                                        <span
                                                                            class="btn-text">Make Receive</span><span
                                                                            class="icon-label"><i
                                                                    ...
                                                                    @elseif ($device->status == 'pending-receiving')
                                                                    <a
                                                                    href="{{ route('receive.create' ,['continueReceiveDeviceId' => $device->id]) }}"
                                                                        class="btn btn-gradient-info  btn-wth-icon icon-wthot-bg btn-rounded icon-right">
                                                                        <span
                                                                            class="btn-text">Comp-Receive</span><span
                                                                            class="icon-label"><i
                                                                                class="fa fa-angle-right"></i>
                                                                        </span>
                                                                    </a>
                                                                    ...
                                                                    @elseif ($device->status == 'pending-cancel')
                                                                    <a
                                                                    href="{{ route('comp.clear' ,['id' => $device->id]) }}"
                                                                        class="btn btn-gradient-info  btn-wth-icon icon-wthot-bg btn-rounded icon-right">
                                                                        <span
                                                                            class="btn-text">Comp-Clear</span><span
                                                                            class="icon-label"><i
                                                                                class="fa fa-angle-right"></i>
                                                                        </span>
                                                                    </a>
                                                                ...
                                                                {{-- <div class="modal fade"
                                                                    id="exampleModalCenter{{ $employee->id }}"
