        ...
        <div class="row">
            <div class="col-xl-12 pa-0">
                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-light nav-tabs col-6" id="list-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#printers" id="list-of-printers" data-toggle="list" role="tab"
                                        aria-controls="list-of-printers"
                                        class="d-flex h-60p align-items-center nav-link">Rental Printers</a>
                                </li>
                ...
                <div class="tab-content mt-sm-60 mt-30">
                    ...
                    <div class="tab-pane fade show " id="printers" aria-labelledby="list-of-printers" role="tabpanel">
                        <div class="container">
                            <div class="hk-row">
                                <div class="col-lg-12">
