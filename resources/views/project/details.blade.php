        ...
        <div class="row">
            <div class="col-xl-12 pa-0">
                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="nav nav-light nav-tabs col-6" id="list-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#employee" id="list-of-employee" data-toggle="list" role="tab"
                                        aria-controls="list-of-employee"
                                        class="d-flex h-60p align-items-center nav-link">Employees</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li
                                    ...
                                    <a href="{{ route('project.index') }}"
                                        class="btn btn-gradient-info btn-wth-icon btn-rounded icon-right"><span
                                            class="btn-text">View All Projects</span> <span class="icon-label"><span
                ...
                <div class="tab-content mt-sm-60 mt-30">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Of course, wed be remiss not to include the
                    ...
                    <div class="tab-pane fade show " id="employee" aria-labelledby="list-of-employee" role="tabpanel">
                        <div class="container">
                            <div class="hk-row">
                                <div class="col-lg-8">
                                    <div class="card card-profile-feed">
